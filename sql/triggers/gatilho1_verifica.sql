...
--foi introduzido o seguinte jogo:
...
--Agora, tentamos introduzir esse jogo como um jogo da fase de eliminação
--tentar inserir um jogo na final com equipas que nao passaram a fase de eliminação

INSERT INTO Jogo_elem VALUES(17, "Finals");

--Como as equipas não passaram a fase de eliminação, não é possivel adicionar o jogo, ignorando o  ultimo inseret, e apagando o jogo que foi introduzido anteriormente
